// H2 用例（h2p_c5_lw2）——8 banks, lane=2
...
module h2p_c5_lw2 (
    ...
    wire [7:0] base4 = d[39:32];
    wire [7:0] base5 = d[47:40];
    wire [7:0] base6 = d[55:48];
    wire [7:0] base7 = d[63:56];
    ...
    wire [7:0] r4_0 = {base4[7:6], base4[5:4], base4[3:2], base4[1:0]};
    wire [7:0] r4_1 = {base4[1:0], base4[7:6], base4[5:4], base4[3:2]};
    wire [7:0] r4_2 = {base4[3:2], base4[1:0], base4[7:6], base4[5:4]};
    wire [7:0] r4_3 = {base4[5:4], base4[3:2], base4[1:0], base4[7:6]};
    wire [7:0] r5_0 = {base5[7:6], base5[5:4], base5[3:2], base5[1:0]};
    wire [7:0] r5_1 = {base5[1:0], base5[7:6], base5[5:4], base5[3:2]};
    wire [7:0] r5_2 = {base5[3:2], base5[1:0], base5[7:6], base5[5:4]};
    wire [7:0] r5_3 = {base5[5:4], base5[3:2], base5[1:0], base5[7:6]};
    wire [7:0] r6_0 = {base6[7:6], base6[5:4], base6[3:2], base6[1:0]};
    wire [7:0] r6_1 = {base6[1:0], base6[7:6], base6[5:4], base6[3:2]};
    wire [7:0] r6_2 = {base6[3:2], base6[1:0], base6[7:6], base6[5:4]};
    wire [7:0] r6_3 = {base6[5:4], base6[3:2], base6[1:0], base6[7:6]};
    wire [7:0] r7_0 = {base7[7:6], base7[5:4], base7[3:2], base7[1:0]};
    wire [7:0] r7_1 = {base7[1:0], base7[7:6], base7[5:4], base7[3:2]};
    wire [7:0] r7_2 = {base7[3:2], base7[1:0], base7[7:6], base7[5:4]};
    wire [7:0] r7_3 = {base7[5:4], base7[3:2], base7[1:0], base7[7:6]};
    always @* begin
        case (ctrl)
            5'd0: y = r0_0;
            5'd1: y = r0_1;
